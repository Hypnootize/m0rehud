...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.HighlightFgColor						"Pink"
		...
		MainMenu.ArmedTextColor								"Pink"
		MainMenu.Inset										"32"
		
		Menu.TextInset										"6"
		Menu.FgColor										"White"
		Menu.BgColor										"17 17 17 255"
		Menu.ArmedFgColor									"Pink"
		...
		TextEntry.TextColor									"Pink"
		TextEntry.DisabledTextColor							"Pink"
