...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.HighlightFgColor						"Blu"
		...
		ListPanel.SelectedBgColor							"Blu"
		ListPanel.SelectedOutOfFocusBgColor					"TransparentBlackIanctive"
		
		MainMenu.TextColor									"White"
		MainMenu.ArmedTextColor								"Blu"
		MainMenu.Inset										"32"
		
		Menu.TextInset										"6"
		Menu.FgColor										"White"
		Menu.BgColor										"17 17 17 255"
		Menu.ArmedFgColor									"Blu"
		Menu.ArmedBgColor									"Blu"
		...
		TextEntry.TextColor									"Blu"
		TextEntry.DisabledTextColor							"Blu"
		TextEntry.SelectedBgColor							"Blu"
		...
		SectionedListPanel.SelectedBgColor					"Blu"
		...
		Console.TextColor									"Blu"
		Console.DevTextColor								"White"
		
		NewGame.TextColor									"White"
		NewGame.FillColor									"0 0 0 255"
		NewGame.SelectionColor								"Blu"
